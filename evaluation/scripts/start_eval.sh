...
./$SRC_PATH/build/Evaluation/pbrt --outfile output/$SCENE-$INTGR-$ACCEL$FILENAME_POSTFIX.exr --nthreads 8 $SRC_PATH/scenes/$SCENE/eval_base.pbrt | tee $SCENE/$INTGR-$ACCEL$FILENAME_POSTFIX.log
